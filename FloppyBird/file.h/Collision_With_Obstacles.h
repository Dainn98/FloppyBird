...
//     if(SDLCommonFunc::CheckCollision(p_threat_frame.ImplementThreatRect(p_threat,num),bird_.strikeObstacle())){
//         ExploringBird(pipe_,bird_,CollisionObject_);
//     }
//     SDL_DestroyTexture(p_threat_frame.GetObjectTexture());
// }
